...
namespace Heracles
{
	...
	MapF::MapF(tstring sceneName) : SceneBase(sceneName)
	{
	}

	void MapF::BuildScene()
	{
	...
	void MapF::CreateWallCollider()
	{
		CreateWall(this, Vector(0.f, 0.f, 32.f), 128.f, 1.f);
		CreateWall(this, Vector(0.f, 0.f, -32.f), 128.f, 1.f);
		CreateWall(this, Vector(-64.f, 0.f, 0.f), 1.f, 64.f);
		CreateWall(this, Vector(64.f, 0.f, 0.f), 1.f, 64.f);

		CreateWall(this, Vector(-58.f, 0.f, 0.f), 20.f, 20.f);
		CreateWall(this, Vector(46.f, 0.f, 26.f), 45.f, 28.f);
		CreateWall(this, Vector(-12.f, 0.f, -8.f), 10.f, 40.f);
	}

	void MapF::SetMonsterWave()
	{
		std::vector<std::pair<int, Vector>> first = { std::make_pair(1,Vector(-30.f, 0.f, -20.f)) ,std::make_pair(1,Vector(-15.f, 0.f, 20.f)),std::make_pair(1,Vector(-40.f, 0.f, 20.f)) };
		std::vector<std::pair<int, Vector>> second = { std::make_pair(1,Vector(5.f, 0.f, 10.f)) ,std::make_pair(2,Vector(-20.f, 0.f, -10.f)),std::make_pair(1,Vector(15.f, 0.f, 0.f)) };
		//std::vector<std::pair<int, Vector>> third = { std::make_pair(2,Vector(20.f, 0.f, -10.f)) ,std::make_pair(2,Vector(50.f, 0.f,-20.f)),std::make_pair(2,Vector(50.f, 0.f, 0.f)) };
	...
	void MapF::CreateObjects()
	{
		...
		ent1->GetGameObject()->GetComponent<Transform>()->SetPosition(ent1->GetGameObject()->GetComponent<Transform>()->GetWorldPosition() + Vector(2.f, 0.f, 2.f), Space::WORLD);
		...
		ent2->GetGameObject()->GetComponent<Transform>()->SetPosition(ent2->GetGameObject()->GetComponent<Transform>()->GetWorldPosition() + Vector(-18.5f, 0.f, 0.f), Space::WORLD);
		...
		auto rewardBox = CreateRewardBox(this, Vector(50.f, 0.f, 0.f), rewardIdx);
		...
		map->AddComponent<MeshRenderer>()->Init("MapFFloor", "Resources/Model/Stage_64_128_1Wall_2Hole_Floor.ase", RendererBase::ModelType::NONE_AO);
		map->AddComponent<MeshRenderer>()->Init("MapFFloorFrame", "Resources/Model/Stage_64_128_1Wall_2Hole_FloorFrame.ase", RendererBase::ModelType::NONE_AO);
		map->AddComponent<MeshRenderer>()->Init("MapFBrazier", "Resources/Model/Stage_64_128_1Wall_2Hole_Brazier.ase", RendererBase::ModelType::NONE_AO);
		map->AddComponent<MeshRenderer>()->Init("MapFHeraStatue", "Resources/Model/Stage_64_128_1Wall_2Hole_HeraStatue.ase", RendererBase::ModelType::NONE_AO);
		map->AddComponent<MeshRenderer>()->Init("MapFPillar", "Resources/Model/Stage_64_128_1Wall_2Hole_Pillar.ase", RendererBase::ModelType::NONE_AO);
		map->AddComponent<MeshRenderer>()->Init("MapFTapestry", "Resources/Model/Stage_64_128_1Wall_2Hole_Tapestry.ase", RendererBase::ModelType::NONE_AO);
		map->AddComponent<MeshRenderer>()->Init("MapFWall", "Resources/Model/Stage_64_128_1Wall_2Hole_Wall.ase", RendererBase::ModelType::NONE_AO);
	}
	...
	void MapF::CreatePointLights()
	{
		...
		pLight1->position = { 58.9187f, 4.693f, -27.729f };
		...
		pLight2->position = { 18.7745f, 4.693f, 14.2f };
		...
		pLight3->position = { 6.08473f, 4.693f, -27.9059f };
		...
		pLight4->position = { -30.9693f, 4.693f, 28.2603f };
		...
		pLight5->position = { -60.8241f, 4.693f, 15.9629f };
